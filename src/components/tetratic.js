    ...
    componentWillMount(){
        ...
        var p = new Promise(function (resolve, reject) {
            for (var i = 0; i < 21; i++){
                ...
                fetch('https://www.thecolorapi.com/scheme?hex=' + color + '&mode=quad&count=4')
    ...
    render() {
        ...
        for( let i = 0; i < colors.length; i++){
            ...
            colorPallet = colorArray.map( col => {
                return <div key={col} style={{backgroundColor: col, height: '88px', width: '88px'}} className="theColors"><div className="transDivtetra"><p className="toptobottom"><span className="letterSpacing">{col[1]}</span><span className="letterSpacing">{col[2]}</span><span className="letterSpacing">{col[3]}</span><span className="letterSpacing">{col[4]}</span><span className="letterSpacing">{col[5]}</span><span className="letterSpacing">{col[6]}</span></p></div></div>
            })
