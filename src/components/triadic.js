    ...
    render() {
        ...
        for( let i = 0; i < colors.length; i++){
            ...
            colorPallet = colorArray.map( col => {
                return <div key={col} style={{backgroundColor: col, height: '88px', width: '88px'}} className="theColors"><div className="transDivtri"><p className="toptobottom"><span className="letterSpacing">{col[1]}</span><span className="letterSpacing">{col[2]}</span><span className="letterSpacing">{col[3]}</span><span className="letterSpacing">{col[4]}</span><span className="letterSpacing">{col[5]}</span><span className="letterSpacing">{col[6]}</span></p></div></div>
            })
